...
def update_doc_link(previous, new_version):
    ...
    new = readme.replace(f"https://github.com/jgirardet/mydevoirs/releases/download/{previous}/", f"https://github.com/jgirardet/mydevoirs/releases/download/{new_version}/")
